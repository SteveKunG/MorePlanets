package com.stevekung.moreplanets.planets.diona.world.gen.feature;
...
public class WorldGenInfectedPurloniteCrystal extends WorldGenerator
{
    @Override
    public boolean generate(World world, Random rand, BlockPos pos)
    {
        for (int i = 0; i < 2; ++i)
        {
            ...
            {
                Block block = MPBlocks.INFECTED_PURLONITE_CRYSTAL;
