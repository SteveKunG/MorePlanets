package com.stevekung.moreplanets.planets.diona.client.model;
...
public class ModelInfectedPurloniteSlimeBoss extends ModelBase
{
    ...
    public ModelInfectedPurloniteSlimeBoss()
    {
