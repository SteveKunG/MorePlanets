        ...
        for (int snowX = 0; snowX < 16; ++snowX)
        {
            for (int snowZ = 0; snowZ < 16; ++snowZ)
            {
                ...
                if (this.world.canSnowAt(blockpos1, true))
                {
                    ...
                    this.world.setBlockState(blockpos1, biome2 == MPBiomes.COLD_GREEN_VEIN_MOUNTAINS ? MPBlocks.PURIFIED_SNOW_LAYER.getDefaultState() : MPBlocks.INFECTED_SNOW_LAYER.getDefaultState(), 2);
                }
            }
        }
    }
