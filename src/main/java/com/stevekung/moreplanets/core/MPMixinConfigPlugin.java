...
public class MPMixinConfigPlugin implements IMixinConfigPlugin
{
    ...
    {
        if (mixinClassName.equals("com.stevekung.moreplanets.core.mixin.MixinEntity"))
        {
            return !foundMagmaServer;
        }
        else if (mixinClassName.equals("com.stevekung.moreplanets.core.mixin.magma.MixinEntity"))
        {
            return foundMagmaServer;
        }
        return true;
