...
import com.stevekung.moreplanets.planets.chalos.items.ItemCheeseSporeSeed;
import com.stevekung.moreplanets.planets.chalos.items.armor.ItemArmorDiremsium;
import com.stevekung.moreplanets.planets.chalos.items.armor.ItemBreathableDiremsium;
import com.stevekung.moreplanets.planets.diona.items.ItemDarkEnergyPearl;
import com.stevekung.moreplanets.planets.diona.items.ItemInfectedPurloniteBomb;
...
public class MPItems
{
    ...
    public static void init()
    {
        ...
        // Laser Bullet
        MPItems.LASER_BULLET = new ItemBaseMP("laser_bullet").setSortCategory(MPItemCategory.PROJECTILE);
        MPItems.INFECTED_PURLONITE_LASER_BULLET = new ItemBaseMP("infected_purlonite_laser_bullet").setSortCategory(MPItemCategory.PROJECTILE).setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));

        // Schematic
        MPItems.ION_CANNON_SCHEMATIC = new ItemIonCannonSchematic("ion_cannon_schematic").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));
        MPItems.BLACK_HOLE_STORAGE_SCHEMATIC = new ItemBlackHoleStorageSchematic("black_hole_storage_schematic").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));

        // Fish
        MPItems.ZELIUS_FISH = new ItemSpaceFish("zelius_fish", ItemSpaceFish.ItemType.ZELIUS_FISH).setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.GLOWING_ALIEN_FISH = new ItemSpaceFish("glowing_alien_fish", ItemSpaceFish.ItemType.GLOWING_ALIEN_FISH).setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        ...
        MPItems.LASER_GUN = new ItemLaserGun("laser_gun").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));
        MPItems.ALIEN_DEFENDER_REINFORCEMENT = new ItemAlienDefenderReinforcement("alien_defender_reinforcement");
        MPItems.CREATIVE_SPACE_KIT = new ItemCreativeSpaceKit("creative_space_kit").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));
        ...
        MPItems.UPGRADE_TEMPLATE = new ItemBaseMP("upgrade_template").setSortCategory(MPItemCategory.UPGRADE);
        MPItems.SHIELD_DAMAGE_UPGRADE = new ItemBaseMP("shield_damage_upgrade").setSortCategory(MPItemCategory.UPGRADE);
        MPItems.SHIELD_SIZE_UPGRADE = new ItemBaseMP("shield_size_upgrade").setSortCategory(MPItemCategory.UPGRADE);
        MPItems.SHIELD_CAPACITY_UPGRADE = new ItemBaseMP("shield_capacity_upgrade").setSortCategory(MPItemCategory.UPGRADE);
        MPItems.MACHINE_SPEED_UPGRADE = new ItemBaseMP("machine_speed_upgrade").setSortCategory(MPItemCategory.UPGRADE);
        MPItems.GRAVITY_AMULET = new ItemGravityAmulet("gravity_amulet").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));

        //////////////////////// DIONA STUFF ////////////////////////

        // Diona Item
        MPItems.ILLENIUM_INGOT = new ItemBaseMP("illenium_ingot").setSortCategory(MPItemCategory.INGOT);
        MPItems.SETRORIUM_SHARD = new ItemBaseMP("setrorium_shard");
        MPItems.COMPRESSED_ILLENIUM = new ItemCompressedMetal("compressed_illenium").setSortCategory(MPItemCategory.PLATE);
        MPItems.COMPRESSED_SETRORIUM = new ItemCompressedMetal("compressed_setrorium").setSortCategory(MPItemCategory.PLATE);
        MPItems.INFECTED_PURLONITE_SHARD = new ItemBaseMP("infected_purlonite_shard").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.ALIEN_MINER_PART = new ItemBaseMP("alien_miner_part").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.GLOWING_IRON_INGOT = new ItemBaseMP("glowing_iron_ingot").setSortCategory(MPItemCategory.INGOT).setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.BLACK_HOLE_FRAGMENTS = new ItemBaseMP("black_hole_fragments").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));
        MPItems.ANTI_GRAVITY_FRAGMENTS = new ItemAntiGravity("anti_gravity_fragments").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));

        // Other
        MPItems.DIONA_DUNGEON_KEY = new ItemDungeonKeyMP("diona_dungeon_key");
        MPItems.INFECTED_PURLONITE_BOMB = new ItemInfectedPurloniteBomb("infected_purlonite_bomb").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.INFECTED_PURLONITE_SLIMEBALL = new ItemBaseMP("infected_purlonite_slimeball").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.INFECTED_PURLONITE_ARROW = new ItemArrowMP("infected_purlonite_arrow", ItemArrowMP.ArrowType.INFECTED_PURLONITE).setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.DARK_ENERGY_PEARL = new ItemDarkEnergyPearl("dark_energy_pearl").setRarityRGB(ColorUtils.stringToRGB(ItemRarity.ALIEN));
        MPItems.ANTI_GRAVITY_ARROW = new ItemArrowMP("anti_gravity_arrow", ItemArrowMP.ArrowType.ANTI_GRAVITY).setRarityRGB(ColorUtils.stringToRGB(ItemRarity.SPECIAL));

        //////////////////////// CHALOS STUFF ////////////////////////

        // Chalos Item
        MPItems.DIREMSIUM_INGOT = new ItemBaseMP("diremsium_ingot").setSortCategory(MPItemCategory.INGOT);
        MPItems.ZYPTORIUM_INGOT = new ItemBaseMP("zyptorium_ingot").setSortCategory(MPItemCategory.INGOT);
        MPItems.COMPRESSED_DIREMSIUM = new ItemCompressedMetal("compressed_diremsium").setSortCategory(MPItemCategory.PLATE);
        MPItems.COMPRESSED_ZYPTORIUM = new ItemCompressedMetal("compressed_zyptorium").setSortCategory(MPItemCategory.PLATE);
        ...
        MPItems.NIBIRU_DUNGEON_KEY_BOW = new ItemBaseMP("nibiru_dungeon_key_bow").setSortCategory(MPItemCategory.DUNGEON_KEY);
        MPItems.NIBIRU_DUNGEON_KEY_BLADE = new ItemBaseMP("nibiru_dungeon_key_blade").setSortCategory(MPItemCategory.DUNGEON_KEY);
        ...
        MPItems.WASTE_ROD_PICKER = new ItemBaseMP("waste_rod_picker").setSortCategory(MPItemCategory.OTHER_TOOL).setRarityRGB(ColorUtils.stringToRGB(ItemRarity.MACHINE)).setMaxStackSize(1).setMaxDamage(15);
        ...
        // Fronos Item
        MPItems.EXTRAILONITE_INGOT = new ItemBaseMP("extrailonite_ingot").setSortCategory(MPItemCategory.INGOT);
        MPItems.COMPRESSED_EXTRAILONITE = new ItemBaseMP("compressed_extrailonite").setSortCategory(MPItemCategory.PLATE);
        ...
        MPItems.INFECTED_WOOD_SWORD = new ItemRejuvenateSword("infected_wood_sword", ToolMaterial.WOOD, MPBlocks.INFECTED_OAK_PLANKS);
        MPItems.INFECTED_WOOD_SHOVEL = new ItemRejuvenateShovel("infected_wood_shovel", ToolMaterial.WOOD, MPBlocks.INFECTED_OAK_PLANKS);
        MPItems.INFECTED_WOOD_PICKAXE = new ItemRejuvenatePickaxe("infected_wood_pickaxe", ToolMaterial.WOOD, MPBlocks.INFECTED_OAK_PLANKS);
        MPItems.INFECTED_WOOD_AXE = new ItemRejuvenateAxe("infected_wood_axe", ToolMaterial.WOOD, MPBlocks.INFECTED_OAK_PLANKS, EnumToolSpeed.WOOD);
        MPItems.INFECTED_WOOD_HOE = new ItemRejuvenateHoe("infected_wood_hoe", ToolMaterial.WOOD, MPBlocks.INFECTED_OAK_PLANKS);
        ...
        MPItems.NIBIRU_STONE_SWORD = new ItemRejuvenateSword("nibiru_stone_sword", ToolMaterial.STONE, MPBlocks.NIBIRU_COBBLESTONE);
        MPItems.NIBIRU_STONE_SHOVEL = new ItemRejuvenateShovel("nibiru_stone_shovel", ToolMaterial.STONE, MPBlocks.NIBIRU_COBBLESTONE);
        MPItems.NIBIRU_STONE_PICKAXE = new ItemRejuvenatePickaxe("nibiru_stone_pickaxe", ToolMaterial.STONE, MPBlocks.NIBIRU_COBBLESTONE);
        MPItems.NIBIRU_STONE_AXE = new ItemRejuvenateAxe("nibiru_stone_axe", ToolMaterial.STONE, MPBlocks.NIBIRU_COBBLESTONE, EnumToolSpeed.COMMON);
        MPItems.NIBIRU_STONE_HOE = new ItemRejuvenateHoe("nibiru_stone_hoe", ToolMaterial.STONE, MPBlocks.NIBIRU_COBBLESTONE);
