...
import com.stevekung.moreplanets.planets.fronos.world.gen.biome.BiomeFronos;
...
public class MPBiomes
{
    ...
    public static final Biome INFECTED_DEAD_SAVANNA = new BiomeInfectedDeadSavanna(new Biome.BiomeProperties("Infected Dead Savanna").setRainDisabled().setRainfall(0.0F).setTemperature(1.2F).setBaseHeight(0.125F).setHeightVariation(0.05F));
    public static final Biome INFECTED_DEAD_SAVANNA_PLATEAU = new BiomeInfectedDeadSavanna(new Biome.BiomeProperties("Infected Dead Savanna Plateau").setBaseHeight(1.5F).setHeightVariation(0.025F).setTemperature(1.0F).setRainfall(0.0F).setRainDisabled());
    public static final Biome INFECTED_DESERT = new BiomeInfectedDesert(new Biome.BiomeProperties("Infected Desert").setRainDisabled().setRainfall(0.0F).setTemperature(2.0F).setBaseHeight(0.125F).setHeightVariation(0.05F));
    public static final Biome INFECTED_DESERT_HILLS = new BiomeInfectedDesert(new Biome.BiomeProperties("Infected Desert Hills").setBaseHeight(0.45F).setHeightVariation(0.3F).setTemperature(2.0F).setRainfall(0.0F).setRainDisabled());
    public static final Biome INFECTED_RIVER = new BiomeNibiru(new Biome.BiomeProperties("Infected River").setBaseHeight(-0.5F).setHeightVariation(0.0F));
    public static final Biome INFECTED_FROZEN_RIVER = new BiomeNibiru(new Biome.BiomeProperties("Infected Frozen River").setBaseHeight(-0.5F).setHeightVariation(0.0F).setTemperature(0.0F).setRainfall(0.5F).setSnowEnabled());
    public static final Biome INFECTED_OCEAN = new BiomeInfectedOcean(new Biome.BiomeProperties("Infected Ocean").setBaseHeight(-1.0F).setHeightVariation(0.1F));
    public static final Biome INFECTED_FOREST = new BiomeInfectedForest(new Biome.BiomeProperties("Infected Forest").setTemperature(0.7F).setRainfall(0.8F), BiomeInfectedForest.Type.NORMAL);
    public static final Biome INFECTED_WOODED_HILLS = new BiomeInfectedForest(new Biome.BiomeProperties("Infected Wooded Hills").setBaseHeight(0.45F).setHeightVariation(0.3F).setTemperature(0.7F).setRainfall(0.8F), BiomeInfectedForest.Type.NORMAL);
    public static final Biome INFECTED_DEEP_OCEAN = new BiomeInfectedOcean(new Biome.BiomeProperties("Infected Deep Ocean").setBaseHeight(-1.8F).setHeightVariation(0.1F));
    public static final Biome INFECTED_DEAD_DARK_FOREST = new BiomeInfectedForest(new Biome.BiomeProperties("Infected Dead Dark Forest").setTemperature(0.7F).setRainfall(0.8F), BiomeInfectedForest.Type.DARK);
    public static final Biome INFECTED_MOUNTAINS = new BiomeInfectedMountains(new Biome.BiomeProperties("Infected Mountains").setTemperature(0.2F).setRainfall(0.3F).setBaseHeight(1.0F).setHeightVariation(0.5F), BiomeInfectedMountains.Type.NORMAL);
    public static final Biome INFECTED_MOUNTAINS_EDGE = new BiomeInfectedMountains(new Biome.BiomeProperties("Infected Mountains Edge").setBaseHeight(0.8F).setHeightVariation(0.3F).setTemperature(0.2F).setRainfall(0.3F), BiomeInfectedMountains.Type.EXTRA_TREES);
    public static final Biome INFECTED_WOODED_MOUNTAINS = new BiomeInfectedMountains(new Biome.BiomeProperties("Infected Wooded Mountains").setBaseHeight(1.0F).setHeightVariation(0.5F).setTemperature(0.2F).setRainfall(0.3F), BiomeInfectedMountains.Type.EXTRA_TREES);
    public static final Biome INFECTED_SWAMP = new BiomeInfectedSwamp(new Biome.BiomeProperties("Infected Swamp").setTemperature(0.8F).setRainfall(0.9F).setBaseHeight(-0.2F).setHeightVariation(0.1F));
    public static final Biome INFECTED_TAIGA = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Taiga").setBaseHeight(0.2F).setHeightVariation(0.2F).setTemperature(0.25F).setRainfall(0.8F), BiomeInfectedTaiga.Type.NORMAL);
    public static final Biome INFECTED_TAIGA_HILLS = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Taiga Hills").setTemperature(0.25F).setRainfall(0.8F).setBaseHeight(0.45F).setHeightVariation(0.3F), BiomeInfectedTaiga.Type.NORMAL);
    public static final Biome INFECTED_SNOWY_TAIGA = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Snowy Taiga").setBaseHeight(0.2F).setHeightVariation(0.2F).setTemperature(-0.5F).setRainfall(0.4F).setSnowEnabled(), BiomeInfectedTaiga.Type.NORMAL);
    public static final Biome INFECTED_SNOWY_TAIGA_HILLS = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Snowy Taiga Hills").setBaseHeight(0.45F).setHeightVariation(0.3F).setTemperature(-0.5F).setRainfall(0.4F).setSnowEnabled(), BiomeInfectedTaiga.Type.NORMAL);
    public static final Biome INFECTED_GIANT_TREE_TAIGA = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Giant Tree Taiga").setTemperature(0.3F).setRainfall(0.8F).setBaseHeight(0.2F).setHeightVariation(0.2F), BiomeInfectedTaiga.Type.MEGA);
    public static final Biome INFECTED_GIANT_TREE_TAIGA_HILLS = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Giant Tree Taiga Hills").setBaseHeight(0.45F).setHeightVariation(0.3F).setTemperature(0.3F).setRainfall(0.8F), BiomeInfectedTaiga.Type.MEGA);
    public static final Biome INFECTED_GIANT_SPRUCE_TAIGA = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Giant Spruce Taiga").setBaseBiome("infected_giant_tree_taiga").setBaseHeight(0.2F).setHeightVariation(0.2F).setTemperature(0.25F).setRainfall(0.8F), BiomeInfectedTaiga.Type.MEGA_SPRUCE);
    public static final Biome INFECTED_GIANT_SPRUCE_TAIGA_HILLS = new BiomeInfectedTaiga(new Biome.BiomeProperties("Infected Giant Spruce Taiga Hills").setBaseBiome("infected_giant_tree_taiga_hills").setBaseHeight(0.2F).setHeightVariation(0.2F).setTemperature(0.25F).setRainfall(0.8F), BiomeInfectedTaiga.Type.MEGA_SPRUCE);
    public static final Biome INFECTED_JUNGLE = new BiomeInfectedJungle(new Biome.BiomeProperties("Infected Jungle").setTemperature(0.95F).setRainfall(0.9F), false);
    public static final Biome INFECTED_JUNGLE_HILLS = new BiomeInfectedJungle(new Biome.BiomeProperties("Infected Jungle Hills").setBaseHeight(0.45F).setHeightVariation(0.3F).setTemperature(0.95F).setRainfall(0.9F), false);
    public static final Biome INFECTED_JUNGLE_EDGE = new BiomeInfectedJungle(new Biome.BiomeProperties("Infected Jungle Edge").setTemperature(0.95F).setRainfall(0.8F), true);
    public static final Biome INFECTED_SNOWY_TUNDRA = new BiomeInfectedSnow(new Biome.BiomeProperties("Infected Snowy Tundra").setSnowEnabled().setTemperature(0.0F).setRainfall(0.5F).setBaseHeight(0.125F).setHeightVariation(0.05F), false);
    ...
    public static final Biome INFECTED_SNOWY_BEACH = new BiomeInfectedBeach(new Biome.BiomeProperties("Infected Snowy Beach").setBaseHeight(0.0F).setHeightVariation(0.025F).setTemperature(0.05F).setRainfall(0.3F).setSnowEnabled(), false);
    public static final Biome INFECTED_BADLANDS = new BiomeInfectedBadlands(new Biome.BiomeProperties("Infected Badlands").setTemperature(2.0F).setRainfall(0.0F).setRainDisabled(), false, false);
    public static final Biome INFECTED_WOODED_BADLANDS_PLATEAU = new BiomeInfectedBadlands(new Biome.BiomeProperties("Infected Wooded Badlands Plateau").setBaseHeight(1.5F).setHeightVariation(0.025F).setTemperature(2.0F).setRainfall(0.0F).setRainDisabled(), false, true);
    public static final Biome INFECTED_BADLANDS_PLATEAU = new BiomeInfectedBadlands(new Biome.BiomeProperties("Infected Badlands Plateau").setBaseHeight(1.5F).setHeightVariation(0.025F).setTemperature(2.0F).setRainfall(0.0F).setRainDisabled(), false, false);
    public static final Biome FRONOS_MEADOW = new BiomeFronosMeadow(new Biome.BiomeProperties("Fronos Meadow").setTemperature(0.8F).setRainfall(0.4F).setBaseHeight(0.01F).setHeightVariation(0.05F), true);
    public static final Biome FRONOS_PLAINS = new BiomeFronosMeadow(new Biome.BiomeProperties("Fronos Plains").setTemperature(0.8F).setRainfall(0.4F).setBaseHeight(0.125F).setHeightVariation(0.05F), false);
    public static final Biome FRONOS_RIVER = new BiomeFronos(new Biome.BiomeProperties("Fronos River").setBaseHeight(-0.45F).setHeightVariation(0.0F));
    public static final Biome FRONOS_FOREST = new BiomeFronosForest(new Biome.BiomeProperties("Fronos Forest").setTemperature(0.7F).setRainfall(0.8F).setBaseHeight(0.1F).setHeightVariation(0.05F));
