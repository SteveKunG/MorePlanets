...
import com.stevekung.moreplanets.utils.client.model.ModelBipedTranslucent;
...
public class ModelRegistryUtils
{
    ...
    {
        ModelBipedTranslucent model = new ModelBipedTranslucent(armorSlot == EntityEquipmentSlot.LEGS ? 0.5F : 1.0F);
        model.isChild = false;
