...
public class RenderDarkEnergyReceiver extends CCLRenderBase
{
    ...
    protected CCModelState getCustomTransforms()
    {
        ...
        TRSRTransformation thirdPerson = TransformUtils.get(0, 2.5F, 0, 75, 135, 0, 0.375F);
        ...
        builder.put(TransformType.FIRST_PERSON_RIGHT_HAND, TransformUtils.get(0, 2, 0, 0, 135, 0, 0.4F));
        builder.put(TransformType.FIRST_PERSON_LEFT_HAND, TransformUtils.get(0, 2, 0, 0, 135, 0, 0.4F));
