...
public class MPBlocks
{
    ...
    public static void init()
    {
        ...
        // Others
        MPBlocks.ALBETIUS_WORM_EGG_ROCK = new BlockAlbetiusWormEgg("albetius_worm_egg_rock");
    ...
    private static void register()
    {
        ...
        BlocksItemsRegistry.registerBlock(MPBlocks.DARK_ENERGY_CORE, ItemBlockDescription::new);
        ...
        BlocksItemsRegistry.registerBlock(MPBlocks.NUCLEAR_WASTE_GENERATOR, ItemBlockDescription::new);
