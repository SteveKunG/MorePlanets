...
public class MPPlanets
{
    ...
    public static void init()
    {
        ...
        CelestialRegistryUtils.setBiomeInfo(MPPlanets.NIBIRU, MPBiomes.INFECTED_PLAINS, MPBiomes.INFECTED_DEAD_SAVANNA, MPBiomes.INFECTED_DESERT, MPBiomes.INFECTED_RIVER, MPBiomes.INFECTED_OCEAN, MPBiomes.INFECTED_DEEP_OCEAN, MPBiomes.INFECTED_FOREST, MPBiomes.INFECTED_DEAD_ROOFED_FOREST, MPBiomes.INFECTED_EXTREME_HILLS, MPBiomes.INFECTED_SWAMP, MPBiomes.INFECTED_TAIGA, MPBiomes.INFECTED_JUNGLE, MPBiomes.INFECTED_ICE_PLAINS, MPBiomes.GREEN_VEIN_BADLANDS);
