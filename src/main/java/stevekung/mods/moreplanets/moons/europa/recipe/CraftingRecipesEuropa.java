...
public class CraftingRecipesEuropa
{
    public static void loadRecipes()
    {
        ...
        GameRegistry.addRecipe(new ItemStack(DarkAsteroidsBlocks.alien_fence, 3), new Object[] { "CSC", "CSC", 'S', new ItemStack(Items.stick), 'C', new ItemStack(DarkAsteroidsBlocks.alien_planks) });
        GameRegistry.addRecipe(new ItemStack(DarkAsteroidsBlocks.alien_fence_gate), new Object[] { "SAS", "SAS", 'A', new ItemStack(DarkAsteroidsBlocks.alien_planks), 'S', new ItemStack(Items.stick) });
        GameRegistry.addShapelessRecipe(new ItemStack(EuropaBlocks.europa_planks, 4), new ItemStack(EuropaBlocks.europa_log) );
        GameRegistry.addShapelessRecipe(new ItemStack(DarkAsteroidsBlocks.alien_planks, 4), new ItemStack(DarkAsteroidsBlocks.alien_log) );
        ...
        GameRegistry.addRecipe(new ItemStack(DarkAsteroidsBlocks.alien_wood_stairs, 4), new Object[] { "  X", " XX", "XXX", 'X', new ItemStack(DarkAsteroidsBlocks.alien_planks) });
        ...
        GameRegistry.addRecipe(new ItemStack(MPBlocks.wooden_slab_half, 6, 6), new Object[] { "CCC", 'C', new ItemStack(DarkAsteroidsBlocks.alien_planks) });
