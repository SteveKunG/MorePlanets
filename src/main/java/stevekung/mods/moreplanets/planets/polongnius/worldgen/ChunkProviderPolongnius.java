...
public class ChunkProviderPolongnius extends ChunkProviderGenerate
{
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            new WorldGenSpaceDungeons(PolongniusBlocks.polongnius_ancient_chest, PolongniusBlocks.polongnius_block, MPBlocks.space_mossy_cobblestone, 1).generate(this.worldObj, this.rand, x, y, z);
        }
