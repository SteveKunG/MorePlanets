...
public class CraftingManagerNibiru
{
    ...
    private static void addItemRecipe()
    {
        ...
        RecipeHelper.addRecipe(new ItemStack(MPItems.BREATHABLE_MULTALIC_CRYSTAL_HELMET, 1, 0), new Object[] { "XXX", "XYX", 'Y', new ItemStack(GCItems.oxMask), 'X', MPItems.MULTALIC_CRYSTAL_PIECES });
