...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreplanets:textures/entity/infected_guardian.png");
    ...
    public void doRender(EntityInfectedGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            this.bindTexture(RenderInfectedGuardian.BEAM);
