...
public class EntranceCraterNibiru extends SizedPieceNibiru
{
    ...
    public EntranceCraterNibiru() {}

    public EntranceCraterNibiru(World world, DungeonConfigurationMP configuration, Random rand, int blockPosX, int blockPosZ)
    {
    ...
    {
        return new RoomEntranceNibiru(this.configuration, rand, this.boundingBox.minX + this.boundingBox.getXSize() / 2, this.boundingBox.minZ + this.boundingBox.getZSize() / 2);
    }
}