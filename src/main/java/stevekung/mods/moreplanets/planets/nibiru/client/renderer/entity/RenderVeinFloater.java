...
import stevekung.mods.moreplanets.planets.nibiru.client.renderer.entity.layer.LayerVeinFloaterDeath;
...
public class RenderVeinFloater extends RenderLiving<EntityVeinFloater>
{
    ...
    public RenderVeinFloater(RenderManager manager)
    {
        ...
        this.addLayer(new LayerVeinFloaterDeath());
    }
    ...
    @Override
    protected void preRenderCallback(EntityVeinFloater entity, float partialTicks)
    {
