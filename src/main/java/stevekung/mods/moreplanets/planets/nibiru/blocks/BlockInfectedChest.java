...
public class BlockInfectedChest extends BlockChestMP
{
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos, Block block, BlockPos fromPos)
    {
        ...
        if (tile instanceof TileEntityInfectedChest)
        {
    ...
    protected ILockableContainer getLockableContainer(World world, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityInfectedChest)tile;
                ...
                for (EnumFacing facing : EnumFacing.Plane.HORIZONTAL)
                {
                    ...
                    if (block == this)
                    {
                        ...
                        if (tileentity1 instanceof TileEntityInfectedChest)
                        {
                            ...
                            {
                                ilockablecontainer = new InventoryLargeChest(LangUtils.translate("container.chestDouble"), ilockablecontainer, (TileEntityInfectedChest)tileentity1);
                            }
                            else
                            {
                                ilockablecontainer = new InventoryLargeChest(LangUtils.translate("container.chestDouble"), (TileEntityInfectedChest)tileentity1, ilockablecontainer);
                            }
                        }
                    }
                }
