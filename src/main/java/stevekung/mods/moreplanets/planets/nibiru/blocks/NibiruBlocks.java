...
public class NibiruBlocks
{
    ...
    public static void init()
    {
        ...
        NibiruBlocks.INFECTED_STONE_BRICKS_STAIRS = new BlockStairsMP("infected_stone_bricks_stairs", EnumStairsType.STONE_BRICK);
        ...
        NibiruBlocks.INFECTED_WHEAT = new BlockInfectedWheatCrops("infected_wheat");
        ...
        NibiruBlocks.TERRABERRY = new BlockTerraberryCrops("terraberry");
        ...
        BlocksItemsRegistry.registerBlock(NibiruBlocks.INFECTED_STONE_BRICKS_STAIRS);
        BlocksItemsRegistry.registerBlock(NibiruBlocks.NIBIRU_ANCIENT_CHEST, ItemBlockTESRMP::new);
        ...
        BlocksItemsRegistry.registerBlock(NibiruBlocks.INFECTED_WHEAT, null);
        ...
        BlocksItemsRegistry.registerBlock(NibiruBlocks.NIBIRU_TREASURE_CHEST, ItemBlockTESRMP::new);
        BlocksItemsRegistry.registerBlock(NibiruBlocks.INFECTED_CHEST, ItemBlockTESRMP::new);
        BlocksItemsRegistry.registerBlock(NibiruBlocks.ALIEN_BERRY_CHEST, ItemBlockTESRMP::new);
        BlocksItemsRegistry.registerBlock(NibiruBlocks.MULTALIC_CRYSTAL, ItemBlockTESRMP::new);
        ...
        BlocksItemsRegistry.registerBlock(NibiruBlocks.JUICER_EGG, ItemBlockTESRMP::new);
        ...
        BlocksItemsRegistry.registerBlock(NibiruBlocks.VEIN_FRAME, ItemBlockTESRMP::new);
        ...
        BlocksItemsRegistry.registerBlock(NibiruBlocks.TERRABERRY, null);
        ...
        BlockUtils.setBlockHarvestLevel(NibiruBlocks.INFECTED_STONE_BRICKS_STAIRS, EnumHarvestLevel.PICKAXE, 0);
