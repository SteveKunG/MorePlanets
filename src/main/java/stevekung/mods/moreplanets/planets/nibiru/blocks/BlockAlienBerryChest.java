                ...
                while (iterator.hasNext())
                {
                    ...
                    if (block == this)
                    {
                        ...
                        if (tileentity1 instanceof TileEntityAlienBerryChest)
                        {
                            ...
                            {
                                object = new InventoryLargeChest(LangUtils.translate("container.chestDouble"), (ILockableContainer)object, (TileEntityAlienBerryChest)tileentity1);
                            }
                            else
                            {
                                object = new InventoryLargeChest(LangUtils.translate("container.chestDouble"), (TileEntityAlienBerryChest)tileentity1, (ILockableContainer)object);
                            }
                        }
                    }
                }
