...
public class GenLayerInfectedRiver extends GenLayer
{
    public GenLayerInfectedRiver(long seed, GenLayer parent)
    {
        super(seed);
        super.parent = parent;
    }
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i1 = 0; i1 < areaHeight; ++i1)
        {
            for (int j1 = 0; j1 < areaWidth; ++j1)
            {
                ...
                {
                    aint1[j1 + i1 * areaWidth] = Biome.getIdForBiome(MPBiomes.INFECTED_RIVER);
                }
            }
        }
        return aint1;
