...
public class BlockInfectedCrystallizedCrystal extends BlockBaseMP implements ITileEntityProvider
{
    ...
    public void harvestBlock(World world, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity tile, ItemStack heldStack)
    {
        ...
        {
            player.addPotionEffect(new PotionEffect(MPPotions.INFECTED_CRYSTALLIZED, 60));
        }
        if (!heldStack.isEmpty() && player.getHeldItemMainhand().getItem() instanceof ItemPickaxe)
        {
        ...
        if (entity instanceof EntityLivingBase)
        {
            if (entity instanceof EntityPlayer)
            {
                ...
                else
                {
                    ...
                    living.addPotionEffect(new PotionEffect(MPPotions.INFECTED_CRYSTALLIZED, 60));
                }
            }
        }
    }
    ...
    {
        return MPItems.INFECTED_CRYSTALLIZED_SHARD;
    }
