...
public class EntityInfectedPurloniteSlimeBoss extends EntitySlimeBaseMP implements IMorePlanetsBoss
{
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData data)
    {
        ...
        {
            EntityInfectedPurloniteTentacle tentacle1 = new EntityInfectedPurloniteTentacle(this.world);
            tentacle1.setLocationAndAngles(this.posX + 5.0F, this.posY + 2.5F, this.posZ + 5.0F, 0.0F, 0.0F);
            this.world.spawnEntity(tentacle1);

            EntityInfectedPurloniteTentacle tentacle2 = new EntityInfectedPurloniteTentacle(this.world);
            tentacle2.setLocationAndAngles(this.posX - 5.0F, this.posY + 2.5F, this.posZ - 5.0F, 0.0F, 0.0F);
            this.world.spawnEntity(tentacle2);

            EntityInfectedPurloniteTentacle tentacle3 = new EntityInfectedPurloniteTentacle(this.world);
            tentacle3.setLocationAndAngles(this.posX + 5.0F, this.posY + 2.5F, this.posZ - 5.0F, 0.0F, 0.0F);
            this.world.spawnEntity(tentacle3);

            EntityInfectedPurloniteTentacle tentacle4 = new EntityInfectedPurloniteTentacle(this.world);
    ...
    protected void dealDamage(EntityLivingBase entity)
    {
        if (this.canEntityBeSeen(entity) && this.getDistanceSq(entity) < this.getDetectRange() && entity.attackEntityFrom(DamageSource.causeMobDamage(this), this.getAttackStrength()))
        {
            ...
            entity.addPotionEffect(new PotionEffect(MPPotions.INFECTED_PURLONITE, 200, 1));
        }
    }
    ...
    {
        return new EntityInfectedPurloniteSlimeBoss(this.world);
    }
    ...
    protected void createParticles()
    {
        ...
        for (int j = 0; j < i * 50; ++j)
        {
            ...
            MorePlanetsMod.PROXY.spawnParticle(EnumParticleTypesMP.CUSTOM_BREAKING, d0, this.getEntityBoundingBox().minY, d1, new Object[] { MPItems.INFECTED_PURLONITE_SLIMEBALL });
        }
    }
