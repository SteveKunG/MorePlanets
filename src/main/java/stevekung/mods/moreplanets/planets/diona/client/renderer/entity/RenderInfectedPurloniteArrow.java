...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreplanets:textures/entity/infected_purlonite_arrow.png");

    public RenderInfectedPurloniteArrow(RenderManager manager)
    {
        super(manager);
    }

    @Override
    public void doRender(EntityInfectedPurloniteArrow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityInfectedPurloniteArrow entity)
    {
        return RenderInfectedPurloniteArrow.TEXTURE;
    }
}