...
{
    public EntityInfectedPurloniteSlimeMinion(World world)
    {
        super(world);
    }
    ...
    {
        return this.getSlimeSize() == 1 ? MPLootTables.INFECTED_PURLONITE_SLIME : null;
    }
    ...
    {
        return new EntityInfectedPurloniteSlimeMinion(this.world);
    }
