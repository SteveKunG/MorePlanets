...
{
    public EntityInfectedPurloniteBomb(World world)
    {
        super(world);
    }

    public EntityInfectedPurloniteBomb(World world, EntityLivingBase thrower)
    {
        super(world, thrower);
    }

    public EntityInfectedPurloniteBomb(World world, double x, double y, double z)
    {
        super(world, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        ...
        {
            this.setDead();
            this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().grow(2.5D)).forEach(entity -> entity.addPotionEffect(new PotionEffect(MPPotions.INFECTED_PURLONITE, 128, 1)));
