...
public class CraftingManagerDiona
{
    ...
    {
        RecipeHelper.addRecipe(new ItemStack(MPBlocks.ILLENIUM_BLOCK), new Object[] { "III", "III", "III", 'I', DionaItems.ILLENIUM_INGOT });
        RecipeHelper.addRecipe(new ItemStack(MPBlocks.SETRORIUM_BLOCK), new Object[] { "SSS", "SSS", "SSS", 'S', DionaItems.SETRORIUM_SHARD });
        RecipeHelper.addRecipe(new ItemStack(MPBlocks.GLOWING_IRON_BLOCK), new Object[] { "SSS", "SSS", "SSS", 'S', DionaItems.GLOWING_IRON_INGOT });
        RecipeHelper.addRecipe(new ItemStack(MPBlocks.INFECTED_CRYSTALLIZED_SLIME_BLOCK), new Object[] { "SSS", "SSS", "SSS", 'S', DionaItems.INFECTED_CRYSTALLIZED_SLIMEBALL });
        RecipeHelper.addRecipe(new ItemStack(MPBlocks.INFECTED_CRYSTALLIZED_SEGMENT), new Object[] { "BSB", "BSB", "BSB", 'S', DionaItems.INFECTED_CRYSTALLIZED_SHARD, 'B', DionaItems.INFECTED_CRYSTALLIZED_SLIMEBALL });
    ...
    {
        RecipeHelper.addRecipe(new ItemStack(MPBlocks.INFECTED_CRYSTALLIZED_TORCH, 4), new Object[] { "I", "S", 'I', DionaItems.INFECTED_CRYSTALLIZED_SHARD, 'S', "stickWood" });
        RecipeHelper.addShapelessRecipe(new ItemStack(DionaItems.ILLENIUM_INGOT, 9), MPBlocks.ILLENIUM_BLOCK);
        RecipeHelper.addShapelessRecipe(new ItemStack(DionaItems.SETRORIUM_SHARD, 9), MPBlocks.SETRORIUM_BLOCK);
        RecipeHelper.addShapelessRecipe(new ItemStack(DionaItems.GLOWING_IRON_INGOT, 9), MPBlocks.GLOWING_IRON_BLOCK);
        RecipeHelper.addShapelessRecipe(new ItemStack(DionaItems.INFECTED_CRYSTALLIZED_SLIMEBALL, 9), MPBlocks.INFECTED_CRYSTALLIZED_SLIME_BLOCK);
    ...
    {
        RecipeHelper.addSmeltingRecipe(new ItemStack(MPBlocks.SETRORIUM_ORE), new ItemStack(DionaItems.SETRORIUM_SHARD), 0.8F);
        RecipeHelper.addSmeltingRecipe(new ItemStack(MPBlocks.ILLENIUM_ORE), new ItemStack(DionaItems.ILLENIUM_INGOT), 0.8F);
