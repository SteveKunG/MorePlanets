...
public class EntityInfectedCrystallizedTentacle extends Entity
{
    ...
    public EntityInfectedCrystallizedTentacle(World world, double x, double y, double z)
    {
        this(world);
    ...
    public void onUpdate()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.ticksExisted % 100 == 0)
            {
                ...
                {
                    EntityInfectedCrystallizedWorm worm = new EntityInfectedCrystallizedWorm(this.world);
