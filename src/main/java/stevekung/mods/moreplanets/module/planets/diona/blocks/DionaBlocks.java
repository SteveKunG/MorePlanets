...
public class DionaBlocks
{
    ...
    public static void init()
    {
        ...
        BlocksItemsRegistry.registerBlock(DionaBlocks.DIONA_ANCIENT_CHEST, ItemBlockTESRMP::new);
        BlocksItemsRegistry.registerBlock(DionaBlocks.DIONA_TREASURE_CHEST, ItemBlockTESRMP::new);
        BlocksItemsRegistry.registerBlock(DionaBlocks.ZELIUS_EGG, ItemBlockTESRMP::new);
        ...
        BlocksItemsRegistry.registerBlock(DionaBlocks.LARGE_INFECTED_CRYSTALLIZED, ItemBlockTESRMP::new);
