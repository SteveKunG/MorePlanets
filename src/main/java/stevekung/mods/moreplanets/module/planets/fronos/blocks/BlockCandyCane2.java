...
public class BlockCandyCane2 extends BlockLogMP implements IBlockVariants
{
    ...
    public BlockCandyCane2(String name)
    {
        ...
        this.setDefaultState(this.getDefaultState().withProperty(VARIANT, BlockType.PINK_CANDY_CANE).withProperty(BlockStateProperty.AXIS, BlockStateProperty.EnumAxis.Y));
    ...
    {
        return new VariantsName("pink", "yellow", "purple", "rainbow");
    }
