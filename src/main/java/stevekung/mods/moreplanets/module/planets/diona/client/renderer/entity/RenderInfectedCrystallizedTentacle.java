...
import stevekung.mods.moreplanets.module.planets.diona.client.model.ModelInfectedCrystallizedTentacle;
import stevekung.mods.moreplanets.module.planets.diona.entity.EntityInfectedCrystallizedTentacle;

@SideOnly(Side.CLIENT)
public class RenderInfectedCrystallizedTentacle extends Render<EntityInfectedCrystallizedTentacle>
{
    private ModelBase model = new ModelInfectedCrystallizedTentacle();
