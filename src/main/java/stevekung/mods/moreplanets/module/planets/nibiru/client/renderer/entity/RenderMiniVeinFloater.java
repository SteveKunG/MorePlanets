...
import stevekung.mods.moreplanets.module.planets.nibiru.client.renderer.entity.layer.LayerMiniVeinFloaterDeath;
import stevekung.mods.moreplanets.module.planets.nibiru.entity.EntityMiniVeinFloater;

@SideOnly(Side.CLIENT)
public class RenderMiniVeinFloater extends RenderLiving<EntityMiniVeinFloater>
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreplanets:textures/entity/vein_floater.png");

    public RenderMiniVeinFloater(RenderManager manager)
    {
        super(manager, new ModelVeinFloater(), 1.0F);
        this.addLayer(new LayerMiniVeinFloaterDeath());
    }

    @Override
    public void doRender(EntityMiniVeinFloater entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        super.doRender(entity, x, y, z, entityYaw, partialTicks);

        int range = 16;
        List<EntityPlayer> entitiesAroundBH = entity.world.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB(entity.posX - range, entity.posY - range, entity.posZ - range, entity.posX + range, entity.posY + range, entity.posZ + range));
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityMiniVeinFloater entity)
    {
        return RenderMiniVeinFloater.TEXTURE;
    }

    @Override
    protected void preRenderCallback(EntityMiniVeinFloater entity, float partialTicks)
    {
