...
public class RenderInfectedCrystallizeArrow extends Render<EntityInfectedCrystallizeArrow>
{
    public RenderInfectedCrystallizeArrow(RenderManager manager)
    {
        super(manager);
    }
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityInfectedCrystallizeArrow entity)
    {
