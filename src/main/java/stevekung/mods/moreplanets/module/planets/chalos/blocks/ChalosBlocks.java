...
public class ChalosBlocks
{
    ...
    public static void init()
    {
        ...
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHALOS_ROCK);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHALOS_COBBLESTONE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.DIREMSIUM_ORE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.ZYPTORIUM_ORE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_MILK_ORE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHALOS_IRON_ORE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHALOS_TIN_ORE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHALOS_COPPER_ORE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHALOS_ALUMINUM_ORE);
        CommonRegisterHelper.registerBlock(ChalosBlocks.DIREMSIUM_BLOCK);
        CommonRegisterHelper.registerBlock(ChalosBlocks.ZYPTORIUM_BLOCK);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHALOS_DUNGEON_BRICK);

        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_GRASS_BLOCK);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_DIRT);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_COARSE_DIRT);
        ...
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_MILK_CAKE, ItemBlockDescription::new);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_SPORE_FLOWER, ItemBlockFlower::new);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_GRASS, ItemBlockFlower::new);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_FARMLAND);
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_MILK_FLUID_BLOCK);
        CommonRegisterHelper.registerBlock(ChalosBlocks.GASEOUS_CHEESE_MILK_BLOCK);
        ...
        CommonRegisterHelper.registerBlock(ChalosBlocks.CHEESE_SPORE_CRAFTING_TABLE);
