...
public class CraftingManagerNibiru
{
    ...
    private static void addBlockRecipe()
    {
        ...
        RecipeHelper.addRecipe(new ItemStack(NibiruBlocks.INFECTED_CUT_SANDSTONE_STAIRS, 4), new Object[] { "X  ", "XX ", "XXX", 'X', new ItemStack(NibiruBlocks.INFECTED_CUT_SANDSTONE, 1) });
