...
public class ContainerDarkEnergyStorage extends Container
{
    private TileEntityDarkEnergyStorageCluster tileEntity;

    public ContainerDarkEnergyStorage(InventoryPlayer invPlayer, TileEntityDarkEnergyStorageCluster batteryBox)
    {
