...
public class MorePlanetsMod
{
    ...
    protected static final String MAIN_DEPENDENCIES = "required-after:stevekung's_lib@[1.1.9,); required-after:galacticraftcore@[4.0.1.-1,); required-after:galacticraftplanets@[4.0.1.-1,); required-after:micdoodlecore; required-after:mixinbooter; " + MorePlanetsMod.FORGE_VERSION + MorePlanetsMod.DEPENDENCIES;
