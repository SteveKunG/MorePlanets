    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> tooltip, IWailaDataAccessor accessor, IWailaConfigHandler config)
    {
        ...
        if (tile instanceof TileEntityFurnaceMP)
        {
            ...
            if (inventory[0] != null)
            {
                ...
                text += SpecialChars.getRenderString("waila.stack", "1", name, String.valueOf(inventory[0].stackSize), String.valueOf(inventory[0].getItemDamage()));
            }
            else
            {
            ...
            if (inventory[1] != null)
            {
                ...
                text += SpecialChars.getRenderString("waila.stack", "1", name, String.valueOf(inventory[1].stackSize), String.valueOf(inventory[1].getItemDamage()));
            }
            else
            {
                text += SpecialChars.getRenderString("waila.stack", "2");
            ...
            if (inventory[2] != null)
            {
                ...
                text += SpecialChars.getRenderString("waila.stack", "1", name, String.valueOf(inventory[2].stackSize), String.valueOf(inventory[2].getItemDamage()));
            }
            else
            {
                text += SpecialChars.getRenderString("waila.stack", "2");
