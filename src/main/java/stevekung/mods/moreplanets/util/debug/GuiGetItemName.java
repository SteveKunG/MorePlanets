...
public class GuiGetItemName extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if (this.mc.thePlayer.getHeldItemMainhand() != null)
        {
            this.textField.setText(this.mc.thePlayer.getHeldItemMainhand().getDisplayName());
            GuiScreen.setClipboardString(this.mc.thePlayer.getHeldItemMainhand().getDisplayName());
        }
    }
