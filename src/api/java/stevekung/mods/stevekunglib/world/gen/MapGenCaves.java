...
{
    protected IBlockState lava;
    protected IBlockState grass;

    private MapGenCaves()
    {
        this.lava = Blocks.LAVA.getDefaultState();
        this.grass = Blocks.GRASS.getDefaultState();
    }
    ...
    protected boolean isTopBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ)
    {
        ...
        return this.isExceptionBiome(biome) ? state.getBlock() == this.grass : state.getBlock() == biome.topBlock;
    }
