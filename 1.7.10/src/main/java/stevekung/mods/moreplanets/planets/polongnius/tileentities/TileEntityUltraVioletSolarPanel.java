...
public class TileEntityUltraVioletSolarPanel extends TileBaseUniversalElectricalSource implements IMultiBlock, IDisableableMachine, IInventory, ISidedInventory, IConnector
{
