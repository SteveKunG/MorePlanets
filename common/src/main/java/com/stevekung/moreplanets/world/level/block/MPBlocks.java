...
public class MPBlocks
{
    ...
    public static final Block PURLONITE_BLOCK = new PurloniteBlock(BlockProperties.of(Material.AMETHYST, MaterialColor.COLOR_PURPLE).tool(ToolType.PICKAXE).strength(1.5F).lightLevel(state -> 5).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().noOcclusion().isValidSpawn(MPBlocks::never).isRedstoneConductor(MPBlocks::never).isSuffocating(MPBlocks::never).isViewBlocking(MPBlocks::never));
    public static final Block BUDDING_PURLONITE = new BuddingPurloniteBlock(BlockProperties.of(Material.AMETHYST).tool(ToolType.PICKAXE).strength(1.5F).sound(SoundType.AMETHYST).lightLevel(state -> 5).randomTicks().requiresCorrectToolForDrops().noOcclusion().noDrops().isValidSpawn(MPBlocks::never).isRedstoneConductor(MPBlocks::never).isSuffocating(MPBlocks::never).isViewBlocking(MPBlocks::never));
    ...
    public static final Block PURLONITE_CLUSTER = new PurloniteClusterBlock(7, 3, BlockProperties.of(Material.AMETHYST).tool(ToolType.PICKAXE).noOcclusion().randomTicks().sound(SoundType.AMETHYST_CLUSTER).strength(1.5F).lightLevel(state -> 5).noOcclusion().isValidSpawn(MPBlocks::never).isRedstoneConductor(MPBlocks::never).isSuffocating(MPBlocks::never).isViewBlocking(MPBlocks::never));
    public static final Block SMALL_PURLONITE_BUD = new PurloniteClusterBlock(3, 4, BlockProperties.copy(PURLONITE_CLUSTER).tool(ToolType.PICKAXE).sound(SoundType.SMALL_AMETHYST_BUD).lightLevel(state -> 2).noOcclusion().isValidSpawn(MPBlocks::never).isRedstoneConductor(MPBlocks::never).isSuffocating(MPBlocks::never).isViewBlocking(MPBlocks::never));
    public static final Block MEDIUM_PURLONITE_BUD = new PurloniteClusterBlock(4, 3, BlockProperties.copy(PURLONITE_CLUSTER).tool(ToolType.PICKAXE).sound(SoundType.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).noOcclusion().isValidSpawn(MPBlocks::never).isRedstoneConductor(MPBlocks::never).isSuffocating(MPBlocks::never).isViewBlocking(MPBlocks::never));
    public static final Block LARGE_PURLONITE_BUD = new PurloniteClusterBlock(5, 3, BlockProperties.copy(PURLONITE_CLUSTER).tool(ToolType.PICKAXE).sound(SoundType.LARGE_AMETHYST_BUD).lightLevel(state -> 4).noOcclusion().isValidSpawn(MPBlocks::never).isRedstoneConductor(MPBlocks::never).isSuffocating(MPBlocks::never).isViewBlocking(MPBlocks::never));
