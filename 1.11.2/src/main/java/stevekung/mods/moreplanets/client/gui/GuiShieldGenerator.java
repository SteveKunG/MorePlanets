...
public class GuiShieldGenerator extends GuiContainerGC implements ICheckBoxCallback
{
    ...
    public void initGui()
    {
        ...
        this.checkboxRenderShield = new GuiElementCheckbox(100, this, width + 88, height + 98, "");
        this.checkboxIncreaseKnock = new GuiElementCheckboxMP(101, this, width + 103, height + 98, "");
        this.checkboxDecreaseKnock = new GuiElementCheckboxMP(102, this, width + 118, height + 98, "");
