...
public class SlotTier6RocketSchematic extends SlotRocketSchematicMP
{
    private int index;

    public SlotTier6RocketSchematic(IInventory inv, int index, int xDisplay, int yDisplay, BlockPos pos, EntityPlayer player)
    {
    ...
    public boolean isItemValid(ItemStack itemStack)
    {
        ...
        case 2:
            return item == NibiruItems.NIBIRU_ITEM && meta == 4 ? true : false; // Rocket Plate
        case 3:
            return item == NibiruItems.NIBIRU_ITEM && meta == 4 ? true : false; // Rocket Plate
        case 4:
            return item == NibiruItems.NIBIRU_ITEM && meta == 4 ? true : false; // Rocket Plate
