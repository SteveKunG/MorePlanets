...
public class SlotTier4RocketSchematic extends SlotRocketSchematicMP
{
    ...
    public SlotTier4RocketSchematic(IInventory inv, int index, int xDisplay, int yDisplay, BlockPos pos, EntityPlayer player)
    {
    ...
    public boolean isItemValid(ItemStack itemStack)
    {
        ...
        case 2:
            return item == DionaItems.TIER_4_ROCKET_PART && meta == 0 ? true : false; // Rocket Plate
        case 3:
            return item == DionaItems.TIER_4_ROCKET_PART && meta == 0 ? true : false; // Rocket Plate
        case 4:
            return item == DionaItems.TIER_4_ROCKET_PART && meta == 0 ? true : false; // Rocket Plate
