...
public class WorldGenLiquidLakes extends WorldGenerator
{
    ...
    private Block stone;
    private int meta;
    private boolean genStone;

    public WorldGenLiquidLakes(Block block, Block stone, int meta, boolean genStone)
    {
        this.liquid = block;
        this.stone = stone;
        this.meta = meta;
    ...
    public boolean generate(World world, Random rand, BlockPos pos)
    {
        ...
        else
        {
            ...
            if (this.liquid.getDefaultState().getMaterial() == Material.LAVA || this.genStone)
            {
                for (j = 0; j < 16; ++j)
                {
                    for (k1 = 0; k1 < 16; ++k1)
