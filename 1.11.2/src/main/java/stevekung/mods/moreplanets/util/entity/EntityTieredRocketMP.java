...
public abstract class EntityTieredRocketMP extends EntityTieredRocket
{
    public EntityTieredRocketMP(World world)
    {
        super(world);
    }

    public EntityTieredRocketMP(World world, double x, double y, double z)
    {
        super(world, x, y, z);
    }

    @Override
    public ItemStack getPickedResult(RayTraceResult moving)
    {
        return new ItemStack(this.getRocketItem(), 1, this.rocketType.getIndex());
    }
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
    {
        ...
        ItemStack rocket = new ItemStack(this.getRocketItem(), 1, this.rocketType.getIndex());
    ...
    protected abstract Item getRocketItem();
}