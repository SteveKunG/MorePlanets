...
public class WorldGenMinableMP extends WorldGenerator
{
    private IBlockState oreBlock;
    private IBlockState fillBlock;
    private int numberOfBlocks;

    public WorldGenMinableMP(IBlockState oreBlock, IBlockState fillBlock, int numberOfBlocks)
    {
    ...
    public WorldGenMinableMP(IBlockState oreBlock, IBlockState fillBlock, EnumOreGen oreGen)
    {
        this.oreBlock = oreBlock;
