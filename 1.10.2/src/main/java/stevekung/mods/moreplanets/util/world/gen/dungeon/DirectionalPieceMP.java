...
public abstract class DirectionalPieceMP extends PieceMP
{
    private EnumFacing direction;

    public DirectionalPieceMP() {}

    public DirectionalPieceMP(DungeonConfigurationMP configuration, EnumFacing direction)
    {
        super(configuration);
