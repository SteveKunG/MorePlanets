...
public class BlockTerrastoneFurnace extends BlockContainerMP implements ISingleBlockRender
{
    ...
    public static void setState(boolean active, World world, BlockPos pos)
    {
        ...
        if (active)
        {
            world.setBlockState(pos, NibiruBlocks.TERRASTONE_LIT_FURNACE.getDefaultState().withProperty(BlockStateHelper.FACING_HORIZON, iblockstate.getValue(BlockStateHelper.FACING_HORIZON)), 3);
            world.setBlockState(pos, NibiruBlocks.TERRASTONE_LIT_FURNACE.getDefaultState().withProperty(BlockStateHelper.FACING_HORIZON, iblockstate.getValue(BlockStateHelper.FACING_HORIZON)), 3);
        }
        else
        {
            world.setBlockState(pos, NibiruBlocks.TERRASTONE_FURNACE.getDefaultState().withProperty(BlockStateHelper.FACING_HORIZON, iblockstate.getValue(BlockStateHelper.FACING_HORIZON)), 3);
            world.setBlockState(pos, NibiruBlocks.TERRASTONE_FURNACE.getDefaultState().withProperty(BlockStateHelper.FACING_HORIZON, iblockstate.getValue(BlockStateHelper.FACING_HORIZON)), 3);
        }
