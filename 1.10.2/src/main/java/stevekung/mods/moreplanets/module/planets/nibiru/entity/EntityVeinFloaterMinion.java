            ...
            else if (d0 < 30.0D)
            {
                ...
                if (this.attackTime <= 0)
                {
                    ...
                    if (this.attackStep > 1)
                    {
                        ...
                        for (int i = 0; i < 1; ++i)
                        {
                            EntityVeinBall entitysmallfireball = new EntityVeinBall(this.entity.worldObj, this.entity, d1 + this.entity.getRNG().nextGaussian() * f, d2, d3 + this.entity.getRNG().nextGaussian() * f);
