...
public class ItemTier6Rocket extends ItemRocketBaseMP implements IHoldableItem, ISortableItem
{
    ...
    {
        EntityTier6Rocket rocket = new EntityTier6Rocket(world, centerX, centerY, centerZ, EnumRocketType.values()[itemStack.getItemDamage()]);
    ...
    {
        EntityTier6Rocket rocket = new EntityTier6Rocket(Minecraft.getMinecraft().theWorld, 0, 0, 0, EnumRocketType.values()[itemStack.getItemDamage()]);
