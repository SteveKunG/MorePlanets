package stevekung.mods.moreplanets.module.planets.chalos.entity.projectile;
...
public class EntityCheeseSpore extends EntityFireball
{
    ...
    protected void onImpact(RayTraceResult moving)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            {
                moving.entityHit.attackEntityFrom(DamageSource.causeFireballDamage(this, this.shootingEntity), 5.0F);
            ...
            if (this.rand.nextInt(4) == 0)
            {
                if (!this.worldObj.isRemote)
                {
                    ...
                    for (int i = 0; i < b0; ++i)
                    {
                        ...
                        slime.setSlimeSize(this.worldObj.rand.nextInt(2));
            ...
            this.worldObj.newExplosion((Entity)null, this.posX, this.posY, this.posZ, 1.0F, false, flag);
            this.setDead();
        }
    }
