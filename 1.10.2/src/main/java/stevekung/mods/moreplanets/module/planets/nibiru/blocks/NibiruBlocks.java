...
import stevekung.mods.moreplanets.module.planets.nibiru.itemblocks.*;
...
public class NibiruBlocks
{
    ...
    public static void init()
    {
        ...
        NibiruBlocks.INFECTED_SAND = new BlockFallingMP("infected_sand").setHardness(0.5F).setStepSound(Block.soundTypeSand);
        ...
        CommonRegisterHelper.registerBlock(NibiruBlocks.NIBIRU_TALL_GRASS, ItemBlockMultiVariant.class);
        ...
        CommonRegisterHelper.registerBlock(NibiruBlocks.NIBIRU_SAPLING, ItemBlockMultiVariant.class);
        ...
        CommonRegisterHelper.registerBlock(NibiruBlocks.NIBIRU_FLOWER, ItemBlockMultiVariant.class);
        ...
        CommonRegisterHelper.registerBlock(NibiruBlocks.MULTALIC_CRYSTAL, ItemBlockMultalicCrystal.class);
        ...
        CommonRegisterHelper.registerBlock(NibiruBlocks.NIBIRU_SEAWEED, ItemBlockMultiVariant.class);
        ...
        CommonRegisterHelper.registerBlock(NibiruBlocks.MULTALIC_CRYSTAL_BLOCK, ItemBlockMultalicCrystalBlock.class);
