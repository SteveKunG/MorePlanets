...
public class RenderMiniVeinFloater extends RenderLiving<EntityMiniVeinFloater>
{
    ...
    public void doRender(EntityMiniVeinFloater entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        int range = 16;
        List<EntityPlayer> entitiesAroundBH = entity.worldObj.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB(entity.posX - range, entity.posY - range, entity.posZ - range, entity.posX + range, entity.posY + range, entity.posZ + range));
