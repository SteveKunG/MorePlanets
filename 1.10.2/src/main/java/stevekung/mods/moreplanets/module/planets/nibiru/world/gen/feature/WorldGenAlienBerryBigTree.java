...
public class WorldGenAlienBerryBigTree extends WorldGenAbstractTree
{
    ...
    List<WorldGenAlienBerryBigTree.FoliageCoordinates> field_175948_j;
    ...
    void generateLeafNodeList()
    {
        ...
        this.field_175948_j = Lists.<WorldGenAlienBerryBigTree.FoliageCoordinates>newArrayList();
        this.field_175948_j.add(new WorldGenAlienBerryBigTree.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.field_175948_j.add(new WorldGenAlienBerryBigTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeaves()
    {
        for (WorldGenAlienBerryBigTree.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.field_175948_j)
        {
